		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-4 " style="top: 150px;">
					...
					<c:out value="${product.product_id }" default="out missing" />
					<img
						src="C:\Users\user\Desktop\DemoBeanBook\src\main\webapp\images\<c:out value="${product.product_id}"/>.jpg"
						width="60%">
					...
					<div class="row">
						<div class="row">
							...
							<div class="col-md-8 portfolio-item" style="top: 50px;">
								<div class="clearfix">
								...
								<div class="clearfix well well-sm">
									<ul>
										...
										<!--  <li>優惠價：<strong> <b>${product.discount_price}</b></strong>元 </li>  -->
